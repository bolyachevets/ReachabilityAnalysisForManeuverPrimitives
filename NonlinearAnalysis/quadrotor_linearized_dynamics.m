...
%                     + abs(computeErrorBound(u1_bar, x5_bar, zonotope(horzcat(center_reach(A_aug_d, B_d, center(IC_Z), center(u_Z), i) ...
%                     + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_cx(1:2*i)), 2), ...
%                     (A_aug_d^i)*IC_Z_generators(:,1) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx1(1:2*i)), 2), ...
%                     (A_aug_d^i)*IC_Z_generators(:,2) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx2(1:2*i)), 2), ...
%                     (A_aug_d^i)*IC_Z_generators(:,3) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx3(1:2*i)), 2), ... 
%                     (A_aug_d^i)*IC_Z_generators(:,4) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx4(1:2*i)), 2), ...
%                     (A_aug_d^i)*IC_Z_generators(:,5) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx5(1:2*i)), 2), ...
%                     (A_aug_d^i)*IC_Z_generators(:,6) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx6(1:2*i)), 2))), u_Z)) 
                    ...
                    - abs((A_aug_d^i)*IC_Z_generators(:,4) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx4(1:2*i)), 2)) ...
                    - abs((A_aug_d^i)*IC_Z_generators(:,5) + sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx5(1:2*i)), 2)) ...
                    - abs((A_aug_d^i)*IC_Z_generators(:,6) - sum(generator_matrix(A_aug_d, B_d, u_Z_generators, i, alpha_gx6(1:2*i)), 2)) >= infimum(StateConstr)
